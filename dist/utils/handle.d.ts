...
export declare type TSafeReturn < T > = readonly[T, Error];
...
export declare function safeSync < A extends unknown[], T > (func: Callable < A, T > , that ? : unknown): TSafeSync < A, Await < T >> ;
